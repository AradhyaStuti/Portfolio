...
const allProjects = [
  ...
  { _id: '4', title: 'GitlessForge', category: 'web', description: 'Distributed version control and DevOps platform with custom VCS, CI/CD pipelines, and a 24-command CLI.', longDescription: 'A distributed version control and DevOps platform built from scratch with no Git dependency.\n\n• Custom file-based version control system storing commits as JSON snapshots\n• Branching, merging, and a 24-command terminal interface\n• CI/CD pipelines executing real shell commands with exit codes, timeouts, and injection prevention\n• Static code review using Myers diff algorithm\n• Child process spawning for build automation', techStack: ['Node.js', 'JavaScript', 'JSON', 'Myers Diff', 'Shell', 'CI/CD'], githubUrl: 'https://github.com/AradhyaStuti/GitlessForge-Distributed-Version-Control-Automation-Platform.git', highlights: ['Custom VCS engine', 'No Git dependency', '24-command CLI', 'Myers diff code review'] },
