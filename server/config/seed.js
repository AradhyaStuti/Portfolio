...
const seedData = () => {
  ...
  store.insertMany('projects', [
    ...
    {
      title: 'GitForge',
      description: 'Code hosting platform with custom VCS, CI/CD pipelines, and Kanban boards. 129 tests.',
      longDescription: 'A full-featured code hosting and collaboration platform built from scratch.\n\n• Custom file-based version control system\n• Real CI/CD pipeline execution\n• Static code review with Myers diff algorithm\n• Kanban boards for project management\n• Hybrid GraphQL + REST API\n• Redis caching, JWT + API key authentication\n• Audit logging and webhook integrations',
      category: 'web',
      techStack: ['React 18', 'Node.js', 'MongoDB', 'GraphQL', 'Redis', 'Socket.IO', 'Docker'],
      githubUrl: 'https://github.com/AradhyaStuti/GitForge-Distributed-Version-Control-Automation-Platform.git',
      highlights: ['Custom VCS engine', 'Real CI/CD pipelines', 'GraphQL + REST API', '129 tests'],
      order: 4,
    },
    {
